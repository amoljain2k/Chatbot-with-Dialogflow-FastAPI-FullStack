CREATE DATABASE  IF NOT EXISTS `amols_kitchen` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `amols_kitchen`;
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
-- Host: localhost    Database: amols_kitchen
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Pav Bhaji',60.00),(2,'Chole Bhature',70.00),(3,'Pizza',150.00),(4,'Mango Lassi',70.00),(5,'Masala Dosa',150.00),(6,'Vegetable Biryani',100.00),(7,'Vada Pav',40.00),(8,'Rava Dosa',160.00),(9,'Samosa',20.00);
...
INSERT INTO `order_tracking` VALUES (1,'in progress'),(2,'in progress');
...
INSERT INTO `orders` VALUES (1,3,1,150.00),(1,9,1,20.00),(2,2,1,70.00),(2,4,1,70.00);
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'amols_kitchen'
--
...
-- Dump completed on 2024-07-12 16:18:37
